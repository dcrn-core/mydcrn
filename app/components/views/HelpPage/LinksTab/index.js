...
export const LinksTab = () => (
  <>
    ...
    <div className="help-icons-list">
      ...
      <HelpLink className={"help-github-icon"} href="https://github.com/dcrnofficial/mydcrn" title={<T id="help.github.title" m="GitHub"/>} subtitle={<T id="help.github.subtitle" m="github.com/dcrnofficialmydcrn"/>} />
