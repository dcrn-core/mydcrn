...
**Wallet is the tool for interacting with the blockchain and using Decred-Next as a currency**. You can use it to send and receive DCRN funds, as a personal ledger to record your transactions and to participate in the staking (PoS).
